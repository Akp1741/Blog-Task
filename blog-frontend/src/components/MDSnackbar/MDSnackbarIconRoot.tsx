...
// Define the structure of the ownerState object expected by your component
interface OwnerState {
  color: 'light' | any; // Adjust this based on the actual colors you use
  bgWhite?: any;
}

export default styled(Icon)<any>(({ theme, ownerState }) => {
  const { palette, functions, typography }:any = theme;
